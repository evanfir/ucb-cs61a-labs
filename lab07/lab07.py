...
def cumulative_sum(t):
    ...
    # for branch in t.branches:
    #     cumulative_sum(branch)
    # t.label += b.label for b in branches
...
def is_bst(t):
    ...
    if t.is_leaf():
        ...
        return False
    elif t.branches[0].label <= t.label and bst_max(t.branches[0]) > t.label:
        return False
    elif t.branches[-1].label > t.label and bst_min(t.branches[-1]) <= t.label:
        return False
    elif bst_max(t.branches[0]) > t.label and bst_min(t.branches[-1]) <= t.label:
        return False
    else:
        for branch in t.branches:
